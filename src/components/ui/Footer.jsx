      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-300 max-w-md">
              A platform where writers and readers connect. Share your stories, discover amazing content, and join a community of passionate storytellers.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} BlogHub. Made with <HeartIcon className="h-4 w-4 inline text-red-500" /> by passionate developers.
          </p>
